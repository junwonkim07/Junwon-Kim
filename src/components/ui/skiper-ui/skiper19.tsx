...
// LinePath carries the actual scroll-driven stroke; upstream only exports the demo.
export { LinePath, Skiper19 };

const LinePath = ({
  className,
  scrollYProgress,
  // Upstream hardcodes #C2F84F, a highlighter lime that belongs to the demo's
  // own palette and clashes with everything here.
  stroke = "#C2F84F",
  strokeWidth = 20,
}: {
  className: string;
